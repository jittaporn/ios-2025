...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_barcode_scanner_plus/flutter_barcode_scanner_plus.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_tesseract_ocr/flutter_tesseract_ocr.framework"
